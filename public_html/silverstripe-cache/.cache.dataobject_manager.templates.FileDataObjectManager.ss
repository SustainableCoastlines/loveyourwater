...
$val .=  $item->XML_val("id",null,true) ;
 $val .= <<<SSVIEWER
" class="RequestHandler FormField DataObjectManager FileDataObjectManager 
SSVIEWER;
...
" href="
SSVIEWER;
$val .=  $item->XML_val("UploadLink",null,true) ;
 $val .= <<<SSVIEWER
" alt="upload">
				<span class="uploadlink"><img src="dataobject_manager/images/add.png" alt="" />
SSVIEWER;
$val .=  _t('DataObjectManager.ADD','Add') ;
 $val .= <<<SSVIEWER
 
SSVIEWER;
$val .=  $item->XML_val("ButtonAddTitle",null,true) ;
 $val .= <<<SSVIEWER
</span>
			</a>
		...
		<div class="rounded_table_top_right">
			<div class="rounded_table_top_left">
				<div class="view-controls">
					<a href="
SSVIEWER;
$val .=  $item->XML_val("ListLink",null,true) ;
 $val .= <<<SSVIEWER
" class="viewbutton 
SSVIEWER;
 if($item->hasValue("ListView")) {  ;
 $val .= <<<SSVIEWER
current
SSVIEWER;
 }  ;
...
" title="
SSVIEWER;
$val .=  _t('FileDataObjectManager.LISTVIEW', 'List view') ;
 $val .= <<<SSVIEWER
"><span><img src="dataobject_manager/images/application_view_list.png" alt="" /></span></a>
					<a href="
SSVIEWER;
$val .=  $item->XML_val("GridLink",null,true) ;
 $val .= <<<SSVIEWER
" class="viewbutton 
SSVIEWER;
 if($item->hasValue("GridView")) {  ;
 $val .= <<<SSVIEWER
current
SSVIEWER;
 }  ;
...
" title="
SSVIEWER;
$val .=  _t('FileDataObjectManager.GRIDVIEW', 'Grid view') ;
 $val .= <<<SSVIEWER
"><span><img src="dataobject_manager/images/application_view_icons.png" alt="" /></span></a>
				</div>
...
" type="text" id="srch_fld"  /></span><span class="sbox_r" id="srch_clear"></span>
	...
	<div class="
SSVIEWER;
$val .=  $item->XML_val("ListStyle",null,true) ;
 $val .= <<<SSVIEWER
 column
SSVIEWER;
...
class="sortable-
SSVIEWER;
$val .=  $item->XML_val("sourceClass",null,true) ;
 $val .= <<<SSVIEWER
"
SSVIEWER;
 }  ;
...
SSVIEWER;
 if($item->obj("Top",null,true)->hasValue("ListView")) {  ;
 $val .= <<<SSVIEWER
...
SSVIEWER;
 if($item->obj("Top",null,true)->hasValue("ShowAll")) {  ;
 $val .= <<<SSVIEWER
<span class="handle"><img src="dataobject_manager/images/move_icon.jpg" /></span>
SSVIEWER;
 }  ;
 $val .= <<<SSVIEWER

								<div class="file-icon"><a href="
SSVIEWER;
 if($item->hasValue("CanViewOrEdit")) {  ;
 $val .= <<<SSVIEWER
...
$val .=  $item->XML_val("PopupWidth",null,true) ;
 $val .= <<<SSVIEWER
" class="popup-button editlink tooltip"><img src="
SSVIEWER;
$val .=  $item->XML_val("FileIcon",null,true) ;
 $val .= <<<SSVIEWER
" alt="" /></a></div>
								<div class="file-label"><a href="
SSVIEWER;
 if($item->hasValue("CanViewOrEdit")) {  ;
 $val .= <<<SSVIEWER
...
$val .=  $item->XML_val("PopupWidth",null,true) ;
 $val .= <<<SSVIEWER
" class="popup-button editlink tooltip">
SSVIEWER;
$val .=  $item->XML_val("FileLabel",null,true) ;
 $val .= <<<SSVIEWER
</a></div>
...
$val .=  $item->XML_val("DeleteLink",null,true) ;
 $val .= <<<SSVIEWER
" class="delete-link"><img src="dataobject_manager/images/trash.gif" height="12px" alt="delete" /></a></div>
SSVIEWER;
 }  ;
 $val .= <<<SSVIEWER
