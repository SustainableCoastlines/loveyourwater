	...
	<table width="600px" cellpadding="0" vspace="0" hspace="0" align="center" cellspacing="0">
    	<tr>
        	<td style="color:#1066B2; font-size:16px; line-height:140%; font-weight:normal; margin-top:50px;">
            	<h2 style="color:#1066B2; font-size:18px; font-weight:normal;">Hi $FullName,</h2>
                <p>Thanks for completing a Result Sheet for you to review.</p>
                ...
                <h2 style="color:#1066B2; font-size:18px; font-weight:normal; font-weight:bold;">Results</h2>
                <hr />
