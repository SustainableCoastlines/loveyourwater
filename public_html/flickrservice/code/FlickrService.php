...
class FlickrService extends RestfulService {
    ...
    /**
     * Sets the Flickr userID
     */
    static function setAPIUserID($userID) {
        self::$api_userID = $userID;
    }

    /**
     * Gets the Flickr userID
     */
    function getAPIUserID() {
        return self::$api_userID;
    }
    ...
    function getPhotos($tags=NULL, $user_id="", $per_page=500, $page=1, $sort="date-posted-desc") {
        ...
        $params = array(
            ...
            'tags' => $tags,
            'user_id' => $user_id == "api" ? $this->getAPIUserID() : $this->User($user_id),
            'per_page' => $per_page,
            'page' => $page,
            'sort' => $sort,
    ...
    function getPhotosMT($tags=NULL, $user_id="", $per_page=500, $page=1, $sort="date-posted-desc") {
        $params = array(
            'method' => 'flickr.photos.search',
            'machine_tags' => $tags,
            'user_id' => $user_id == "api" ? $this->getAPIUserID() : $this->User($user_id),
        ...
        try {
            ...
            user_error('Flickr service unavailable',E_USER_ERROR );
        }
